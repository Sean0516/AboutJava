...
13.  JVM 对 Java 的 原 生 锁 做 了 哪 些 优 化
...
17. Condition 类和 Object 类锁方法区别区别
...
18. tryLock 和 lock 和 lockInterruptibly 的区别
...
20. 共享锁和独占锁  （java 并发包提供的加锁模式分为独占锁和共享锁）
...
30. 为什么使用 Executor 框架比使用应用创建和管理线程好
